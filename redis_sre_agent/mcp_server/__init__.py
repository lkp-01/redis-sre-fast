...
- redis_sre_scaffold_skill_package: Scaffold an Agent Skills package from a legacy markdown skill
...
- redis_sre_query: Queue a routed query with optional thread and target context
